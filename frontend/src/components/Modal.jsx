    ...
    <div className="fixed inset-0 w-full h-full bg-black flex items-center justify-center z-50">
      ...
      <div className={`relative flex flex-col bg-white rounded-lg shadow-lg overflow-hidden`}>
        ...
        {!hideHeader && (
          ...
          <button
                type="button"
                className="text-gray-400 bg-transparent hover:bg-orange-100 hover:text-gray-300 rounded-lg text-sm w-8 h-8 flex justify-center items-center absolute top-3.5 right-3.5 cursor-pointer"
                onClick={onClose}
            >
                <svg
