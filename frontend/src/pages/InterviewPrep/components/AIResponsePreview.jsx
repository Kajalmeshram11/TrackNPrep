      ...
      <div className="text-[14px] prose prose-slate dark:prose-invert max-w-none">
        <ReactMarkdown
          ...
          components={{
            ...
            th({children}){
              return <th className="px-3 py-2 whitespace-nowrap text-sm font-medium text-gray-500 uppercase tracking-wider">{children}</th>;
            },
            td({children}){
              return <td className="px-3 py-2 border border-gray-200">{children}</td>;
            },
            hr(){
              return <hr className="my-4 max-w-full rounded" />;
            },
            img({src,alt}){
