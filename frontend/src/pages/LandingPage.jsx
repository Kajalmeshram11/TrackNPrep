  ...
  return (
    <>
      <div className="w-full min-h-full bg-[#FFFCEF]">
        <div className = "w-[500] h-[500px] bg-amber-200/20 blur-[65px] absolute top-0 left-0" />
          ...
          <div className = "flex flex-col md:flex-row items-center">
            ...
            <div className = "w-full md:w-1/2">
              <p className = "text-[17px] text-gray-900 mr-0 md:mr-20 mb-6">
                Transform your interview preparation with our AI-driven platform. Practice, learn, and succeed with personalized feedback and real-time coding challenges. Dive deeper into consepts with curated resources and track your progress effortlessly.
              </p>
              ...
              <div className="flex flex-col items-center gap-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {APP_FEATURES.slice(3).map((feature) => (
                    <div key={feature.id} className="bg-white p-6 rounded-xl shadow-xs hover:shadow-lg shadow-amber-100 transition border border-amber-100">
                      <h3 className="text-base font-semibold mb-3">
                        {feature.title}
                      </h3>
                      <p className="text-gray-600">
